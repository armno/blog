...
<p class="media full">
  <img src="/img/posts/storck-visioner-comp-g1/full-bike.jpg" alt="Storck Visioner Comp G1">
</p>
...
<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/side-view.jpg" alt="Side-view: Storck Visioner Comp G1">
</p>

งานสีและเคลือบเงาเนียนมาก ซึ่งก่อนหน้านี้ผมชอบเฟรมสีดำด้านแบบ Emonda ของเดิม แต่ว่าได้สีเงามาก็สวยไปอีกแบบ แถมเช็ดง่ายกว่าเฟรมสีด้านเยอะเลย

<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/frame-2.jpg" alt="Frame: Storck Visioner Comp G1">
</p>

ตะเกียบคาร์บอน Stiletto ตามสเป็คหนัก 340 กรัม ซับแรงสะเทือนช่วงหน้ารถได้ดีมาก
รู้สึกนิ่ง และรู้สึกสะท้านมือน้อยกว่าตะเกียบของ Emonda ALR

<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/forks.jpg" alt="ตะเกียบหน้่า Stiletto">
</p>
...
ตะเกียบ Stiletto ของ Visioner ให้ระยะ trail ที่มากกว่าตะเกียบของ Emonda ALR เล็กน้อย
_(Visioner 6.11cm, Emonda ALR 5.69cm)_
...
<p class="media text-center">
  <img src="/img/posts/storck-visioner-comp-g1/trails.png" alt="ระยะ trail เทียบกันระหว่าง Storck Visioner กับ Trek Emonda ALR">
</p>
...
ทำให้ช่วงล่าง-ช่วงหลังของ Visioner ให้ความรู้สึก "ไว" - ใช้แรงในการเอียงตัวและถ่วงนำ้หนักน้อยกว่าในการเข้าโค้ง
(Emonda ALR มีระยะ chainstay length อยู่ที่ 410mm)

<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/chainstay.jpg" alt="ระยะ chainstay สั้น ทำให้เข้าโค้งได้ว่องไว">
</p>
...
จริงๆ ชุดเกียร์เดิมที่ติดมากับ Emonda ALR คือ Shimano 105
...
<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/drivetrain.jpg" alt="ชุดขับ SRAM Force 22s">
</p>
...
ที่ไม่ได้เลือกเฟือง Red เพราะว่าของหมด (ยัง!) จริงๆ เพราะช่างบอกว่าปัญหาเยอะ
แถมยังแพงกว่าด้วย พอลองใช้จริงรู้สึกว่าเฟือง Dura-Ace เปลี่ยนเกียร์ได้เนียนกว่า SRAM อยู่นิดหน่อย

<p class="media text-center">
  <img src="/img/posts/storck-visioner-comp-g1/cassettes.jpg" alt="เฟืองหลัง 11-28T ของ Shimano Dura-Ace 9100">
</p>
...
<p class="semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/mavic-ksyrium-pro.jpg" alt="ล้อ Mavic Ksyrium Pro">
</p>
...
<p class="media semi-full">
  <img src="/img/posts/storck-visioner-comp-g1/front-wheel.jpg" alt="ล้อ Mavic Ksyrium Pro">
</p>

แต่ก็มีข้อเสียคือดุมล้อไม่ค่อยลื่นเท่าไหร่ เทียบกับคู่ก่อนหน้าที่เคยใช้คือ Novatec Impulse
คู่นั้นดุมลื่นกว่า พอต้องเลือกระหว่างความลื่นกับความทน ผมเลือกความทนไว้ก่อน
...
ส่วนความทนทานนั้นรู้สึกผมเฉยๆ ไม่ได้โดดเด่นอะไร ถึงแม้จะเป็นรุ่น all season ก็ตาม
...
<p class="text-center">
  <img src="/img/posts/storck-visioner-comp-g1/pirelli-velo-4s.jpg" alt="ยาง Pirelli Velo 4S">
</p>

### เบรค: EE Single Mount

เบรค EE เป็นเบรคที่มีจุดเด่นที่น้ำหนักเบามาก กับประสิทธิภาพที่ว่ากันว่า ดีมากระดับต้นๆ ในบรรดา rim brake ด้วยกัน
แต่ก็แลกมาด้วยค่าตัวที่ค่อนข้างสูงเอาเรื่องอยู่เหมือนกัน

ในด้านการใช้งาน ฟีลลิ่งการเบรคจะค่อนข้างต่างกับเบรค Shimano หรือ SRAM ที่เคยใช้มา
ช่วงแรกๆ ผมต้องฝึกชะลอ ฝึกเลียเบรคกันใหม่ แต่ความละเอียดของมัน ก็ทำให้ใช้งานเบรคได้สนุกกว่าเดิมด้วย
...
_(ในรูปใช้ผ้าเบรคคาร์บอนที่แถมมาเพราะว่าอยากลองดู ตอนนี้ใช้ผ้าเบรค SwissStop Flash Pro BXP)_
...
เบาะ SQLab Ergowave 612 Active ขนาด 15 หลักอาน KCNC Ti Pro Lite ทำจาก scandium น้ำหนักเบามาก
แปะสติ๊กเกอร์ทับไว้เหมือนกัน

<p class="media text-center">
  <img src="/img/posts/storck-visioner-comp-g1/seatpost.jpg" alt="Storck Visioner Comp G1">
</p>
...
<p class="media text-center">
  <img src="/img/posts/storck-visioner-comp-g1/bottle-cage.jpg" alt="ขากระติกคาร์บอน Nich">
</p>
...
องศารถ: Storck Visioner (รวมถึงจักรยานเสือหมอบรุ่นอื่นๆ ของ Storck ทุกรุ่น) นั้นมีมิติรถค่อนข้าง "ซิ่ง"
...
องศาเฟรมโหดขนาดนี้ เลยต้องชดเชยด้วยแหวนรองคอค่อนข้างเยอะ และความยาว stem ที่ลดลงเหลือ 90mm จาก 110mm

<p class="media text-center">
  <img src="/img/posts/storck-visioner-comp-g1/head.jpg" alt="ขากระติกคาร์บอน Nich">
</p>
...
โดยรวมแล้วก็ดีกว่า Emonda ALR คันเดิมแทบทุกด้าน ถึงแม้น้ำหนักเฟรมจะมากไปหน่อย
แต่ก็ชดเชยด้วยการใช้ชิ้นส่วนอื่นที่มีน้ำหนักเบาแทน

<p class="media full">
  <img src="/img/posts/storck-visioner-comp-g1/full-with-mountain.jpg" alt="Storck Visioner Comp G1">
</p>
