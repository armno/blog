...
{{< picture-lazy wrapper-class="semi-full" src="images/side-view.jpg" alt="Side-view: Storck Visioner Comp G1">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/frame-2.jpg" alt="Frame: Storck Visioner Comp G1">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/forks.jpg" alt="ตะเกียบหน้่า Stiletto">}}
...
_(Visioner 611mm, Émonda ALR 569mm)_

ซึ่ง_ตามทฤษฎี_แล้ว รถที่มีระยะ trail มากขึ้น จะทำให้รู้สึกว่าการบังคับควบคุมช่วงหน้ารถจะหนักแน่นกว่า และรู้สึกมั่นคงมากกว่า
แต่บ้างก็ว่าเป็นความรู้สึกที่ "ช้า" ลง (more stable, less twitchy)

{{< picture-lazy src="images/trails.png" alt="ระยะ trail เทียบกันระหว่าง Storck Visioner กับ Trek Émonda ALR">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/chainstay.jpg" alt="ระยะ chainstay สั้น ทำให้เข้าโค้งได้ว่องไว">}}

การออกแบบองศารถแบบนี้ ทำให้ได้ฟิลลิ่งการบังคับรถที่สนุกมาก บังคับควบคุมได้ว่องไว โดยที่ยังรู้สึกหนักแน่นมั่นคง และให้ฟีลเกาะถนนได้ดี
...
{{< picture-lazy wrapper-class="semi-full" src="images/drivetrain.jpg" alt="ชุดขับ SRAM Force 22s">}}
...
{{< picture-lazy src="images/cassettes.jpg" alt="เฟืองหลัง 11-28T ของ Shimano Dura-Ace 9100">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/mavic-ksyrium-pro.jpg" alt="ล้อ Mavic Ksyrium Pro">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/ee-brakes.jpg" alt="เบรค EE พลังเบรคเหลือเฟือ">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/front.jpg" alt="แฮนด์ Easton EC90 SLX3">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/handlebar.jpg" alt="ผ้าพันแฮนด์ Supacaz">}}

ส่วน stem ใช้ของ Uno รุ่นเลข 7 ตัดสติ๊กเกอร์มาแปะทับไว้ เพราะสีสันลวดลายไม่ค่อยเข้ากับรถเท่าไหร่ (ลายสีเทา-แดง)

{{< picture-lazy wrapper-class="semi-full" src="images/stem-right.jpg" alt="stem uno ขนาด 90mm">}}
...
{{< picture-lazy wrapper-class="semi-full" src="images/02.jpg" alt="Storck Visioner Comp G1">}}
...
{{< picture-lazy wrapper-class="full lazy-wrapper lazy-wrapper--16-10" src="images/full-with-mountain.jpg" alt="Storck Visioner Comp G1">}}
