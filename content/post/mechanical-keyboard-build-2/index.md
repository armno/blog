...
{{< picture-lazy wrapper-class="semi-full" src="images/mark1-mark2.jpg" alt="mark 1 กับ mark 2 ที่ทำมาเป็นฝาแฝดกัน" >}}
...
เทคนิคนี้ลอกมาจาก TaeKeyboards

{{< picture-lazy wrapper-class="semi-full" src="images/foam-pad.jpg" alt="รองด้วยแผ่นโฟมกันกระแทก ในเคส ใต้ PCB" >}}

น้ำหนักเฉพาะเคสก็ 800 กว่ากรัมแล้ว ประกอบเสร็จแล้วคีย์บอร์ดเล็กๆ นี่หนัก 1.2kg

{{< picture-lazy wrapper-class="semi-full" src="images/keyboard-weight.jpg" alt="น้ำหนักรวมของ mark 4 อยู่ที่ประมาณ 1.2kg" >}}
...
มั่นคงแข็งแรงกว่า เสียงเงียบกว่าด้วย ถ้าเป็นไปได้ซื้อ Cherry stab ของแท้ดีกว่าครับ
ซื้อของปลอมเสียดายเงินเปล่า
(ผมซื้อจาก [KPRepublic](https://kprepublic.com/products/black-cherry-original-pcb-stabilizers-for-custom-mechanical-keyboard-gh60-xd64-xd60-xd84-eepw84-tada68-zz96-6-25x-2x-7x-rs96-87) กับ [CandyKeys](https://candykeys.com/category:stabilizers))
...
แค่ราคา keycaps ก็แพงกว่า keyboard อันแรกที่ทำทั้งอันแล้ว (แต่ยังมีชุด keycaps ที่แพงกว่านี้อีกเยอะะะครับ)
...
{{< picture-lazy wrapper-class="semi-full" src="images/mark4-on-desk.jpg" alt="custom mechanical keyboard mark 4 บนโต๊ะทำงาน" >}}
...
`LAYER 1`: เพิ่มปุ่มเพิ่ม/ลดแสงหน้าจอลงไป (ตรงเลข 1 กับ 2)
...
{{< picture-lazy wrapper-class="semi-full" src="images/mark5.jpg" alt="custom mechanical keyboard mark 5 ของนีโม่" >}}

ไม่รู้โดนเพื่อนป้ายยามารึเปล่า วันหนึ่งอยู่[ภรรยา](https://nemo.in.th)ผมก็บอกว่า อยากได้ mechanical keyboard ไว้ทำงานบ้าง ทำให้หน่อยอันนึง เอาเล็กๆ แบบของผมนี่แหละ

สเป็คที่เธอขอมาในตอนแรกมีแค่ข้อเดียว คือ ขอปุ่มลูกศรด้วย
...
สเป็คของเจ้า Mark V คือ

- PCB: DZ60 Rev 3.0 เวอร์ชั่น USB Type-C: เป็นเวอร์ชั่น 3.0 ที่ซัพพอร์ต USB Type C to Type C แล้ว แผงวงจรเป็นสีดำ
- Case: Aluminum Low Profile: เป็นอลูมิเนียมเหมือนกัน แต่เป็นแบบ low profile ที่ขนาดเล็กกะทัดรัดกว่าและเตี้ยกว่า เวลาวาง plate ลงไปจะสูงเท่ากันพอดี ปุ่มของคีย์บอร์ดมันเลยดูลอยๆ ขึ้นมา

{{< picture-lazy wrapper-class="semi-full" src="images/mark5-case.jpg" alt="case low profile ของ mark 5" >}}


- Plate: [Stainless Steel (plate B)](https://www.aliexpress.com/item/32827595666.html?spm=2114.search0104.3.9.57e310c2Zh3gqb&ws_ab_test=searchweb0_0%2Csearchweb201602_5_10065_10068_319_10059_10884_317_10887_10696_321_322_10084_453_10083_454_10103_10618_10307_537_536%2Csearchweb201603_52%2CppcSwitch_0&algo_expid=20951708-b20a-4635-b07c-37db2324fb43-1&algo_pvid=20951708-b20a-4635-b07c-37db2324fb43&transAbTest=ae803_5): plate ทีเป็น stainless steel เป็นแบบขัดผิวมาแต่ไม่ได้ทำสี น้ำหนักหนักกว่า alu เยอะพอสมควร
- Switches: Gateron Browns, Yellows หรือเรียกอีกอย่างว่า switch เหลือที่บ้าน นั่นเอง 😅

{{< picture-lazy wrapper-class="semi-full" src="images/mark5-switches.jpg" alt="switch แบบต่างๆที่ใช้ใน mark 5" >}}

- Keycaps: Black PBT, DSA Profile: เธอบอกว่าไม่ค่อยชอบเท่าไหร่ ชอบแบบของ MAXKEYS มากกว่า

{{< picture-lazy wrapper-class="semi-full" src="images/mark5-with-sa-keycaps.jpg" alt="ลองเอา foundation keycaps ใส่กับ mark 5 ดู" >}}
...
poker layout แถวล่างสุดมี 4 ปุ่มขนาด 1.25U แถวที่ 2 ถัดขึ้นมาเป็นปุ่ม Shift ขวา ยาว 2.75U (1U เป็นหน่วยความกว้างของ keycap เท่ากับ 1 ตัวอักษร)

ส่วนรูปบนคือของ Mark V ที่พอต้องมีปุ่มลูกศร ก็เลยต้องแบ่งแถวล่างสุดออกเป็น 5 ปุ่มขนาด 1U ก็จะได้ความยาวเท่ากันพอดี

แถวที่ 2 นั้นเนื่องจากไม่สามารถแบ่งปุ่ม shift ขวาให้เป็น 1U ทั้งหมดแบบลงตัวได้ ก็เลยต้องเอาพื้นที่ของปุ่ม <kbd>?,/</kbd> ไปรวมกับปุ่ม ​<kbd>Shift</kbd> ขวาเป็นขนาด 3.75U แล้วแบ่งเป็น 1.75U, 1U, 1U

และต้องใช้ keycap ของปุ่ม shift ที่เล็กกว่า คือขนาดแค่ 1.75U ไว้ตรง <kbd>?,/</kbd> แทน เพราะไม่งั้นมันจะเหลือที่ว่างระหว่างปุ่มนิดนึง
พูดง่ายๆ ก็คือ เอา keycap ของปุ่มขนาด 1.75U ไปวางไว้บน switch ของปุ่ม <kbd>?,/</kbd> นั่นเอง แต่ตัวปุ่มมันเองยังทำงานเหมือนเดิม
...
คีย์บอร์ดตัวนี้ทำมาเพื่อใช้กับ Windows เป็นหลัก keymap ของ Mark V เลยต่างไปจากของผมนิดหน่อย
