...
แต่ถ้าไม่เคยสั่งมาก่อน (แบบเคสของผม) อาจจะมึนงงในหลายขั้นตอนมาก
ก็ต้องใช้เวลาอีกกว่า 1 สัปดาห์ในขั้นตอนการนำเข้าและเสียภาษี

สิ่งที่อยากบ่นนอกจากกระบวนการที่ค่อนข้างเยอะแล้ว
การติดต่อกับ UPS Thailand ก็ปวดหัวอยู่ไม่น้อย คุยไม่รู้เรื่องเลย ติดต่อก็ยาก ทำเอาหัวร้อนและหงุดหงิดหลายครั้ง

จนนึกไปถึงว่า ถ้ารู้มาก่อนว่า UPS Thailand จะเป็นแบบนี้ ผมอยากจะลองบอก Canyon ตอนสั่งซื้อว่า ขอให้ไม่ส่งมากับ UPS ได้ไหม ขอให้เป็น DHL แทน
(ซึ่งไม่รู้ว่าจริงๆ แล้วทำได้ไหมนะครับ ตอนสั่งซื้อก็ไม่ได้มีให้เลือกบริษัท shipping)
...
(ย้ำอีกครั้ง ผมไม่ได้รู้จักร้านที่รับซื้อ และไม่ได้ค่าโฆษณา)

ในกรณีของผม เรื่องค่าใช้จ่ายอาจจะไม่ต่างกันมาก แต่การต้องเสียเวลา เสียสุขภาพจิต (จากขั้นตอนมากมาย และโดยเฉพาะอย่างยิ่งการติดต่อกับ UPS เพื่อดำเนินการต่างๆ) ก็ต้องบอกว่า ไม่คุ้มเลย

การซื้อจักรยานดีๆ สักคัน มันไม่ควรจะยุ่งยากขนาดนี้
...
ไว้ถ้ามีโอกาส (ละไม่ขี้เกียจ) จะมาเล่าถึงตัวจักรยานต่อไป
