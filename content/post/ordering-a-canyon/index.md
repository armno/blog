...
layout: wide
cover-image: images/box-back.jpg
thumbnail: images/box-back.jpg
...
[Canyon](https://www.canyon.com/) เป็นแบรนด์จักรยานยักษ์ใหญ่จากประเทศเยอรมนีที่ขายจักรยานของตนเองผ่านเว็บไซต์ [canyon.com](https://www.canyon.com) เพียงช่องทางเดียว
...
{{< picture-lazy src="images/switch-country.png" alt="เปลี่ยนประเทศและภาษาได้จากเมนู" >}}
...
{{< picture-lazy src="images/main-menu.png" alt="เมนูหลักของ Canyon.com" >}}
...
{{< picture-lazy src="images/endurace-cf-sl-page.png" alt="เลือก spec ได้จากตรงนี้" >}}

รุ่นที่กำลังลดราคาจะมีป้ายส้มๆ บอกไว้ชัดเจน

{{< picture-lazy src="images/on-sales.png" alt="รุ่นที่กำลังลดราคา จะมีป้ายบอกว่าลดเท่าไหร่" >}}

กดเข้าไปดูสเป็คอย่างละเอียดได้ทุกคัน

{{< picture-lazy src="images/full-specs.png" alt="spec อย่างละเอียด" >}}
...
{{< picture-lazy src="images/frameset-specs.png" alt="spec ของเฟรมเซ็ต" >}}

ส่วนขนาดของแฮนด์ / สเต็ม จะบอกไว้ในตาราง geometry chart ครับ

{{< picture-lazy src="images/geometry-chart.png" alt="ขนาดของแฮนด์ สเต็มที่จะมาพร้อมเฟรมแต่ละไซส์" >}}
...
{{< picture-lazy src="images/price.png" alt="ราคา" >}}
...
{{< picture-lazy src="images/shipping-cost.png" alt="ค่าขนส่ง" >}}
...
{{< picture-lazy src="images/added-to-cart.png" alt="ราคาหลังจากเพ่ิมในรถเข็นแล้ว รวมค่าจักรยานกับค่าขนส่งไว้ด้วยกัน" >}}
...
{{< picture-lazy src="images/availability.png" alt="สถานะความพร้อมส่งของแต่ละ size" >}}
...
{{< picture-lazy src="images/checkout-1.png" alt="หน้า checkout" >}}

{{< picture-lazy src="images/checkout-2.png" alt="อุปกรณ์เสริมที่มีให้เลือกเพิ่มเติม" >}}
...
{{< picture-lazy src="images/payment-options.png" alt="เลือกวิธีการชำระเงิน" >}}
...
{{< picture-lazy src="images/confirmation-email.png" alt="email ยืนยัน order จาก Canyon" >}}

Canyon จะส่งใบสรุปรายการสั่งซื้อเป็น PDF แนบมาด้วย

{{< picture-lazy src="images/order-confirmation.png" alt="ใบสรุปรายการสั่งซื้อ" >}}
...
{{< picture-lazy src="images/contact-form.png" alt="หน้า contact form" >}}
...
{{< picture-lazy src="images/customer-support-reply.png" alt="email ตอบกลับจาก customer support" >}}

รออีกไม่กี่ชั่วโมง ก็ได้รับ email อีกฉบับ บอกว่าสินค้าถูกส่งมาแล้ว พร้อมทั้งเลข tracking number ของ UPS

{{< picture-lazy src="images/tracking-number.png" alt="email อีกฉบับ แจ้งว่าส่งสินค้าแล้ว" >}}
...
{{< picture-lazy src="images/tax.jpg" alt="รูป: ใบแจ้งจากศุลกากร" >}}
...
{{< picture-lazy src="images/cost-before-ship.png" alt="รูป: ใบแสดงค่าใช้จ่ายก่อนส่งสินค้า" >}}
...
หลังจากนั้นกล่อง Canyon ก็ถูกส่งมาถึงที่อยู่ผม ผ่าน Kerry Express อีกที ในที่สุดก็มาถึงมือจนได้ รวมๆ แล้วใช้เวลาประมาณ 10 วันตั้งแต่สั่งซื้อจากเว็บ

{{< picture-lazy wrapper-class="semi-full" src="images/box-front.jpg" alt="กล่องจักรยาน ด้านหน้า" >}}

## สรุป

ระยะเวลา 10 วันนับจากตอนสั่งซื้อ จนถึงของมาถึงมือเรา อาจจะฟังดูไม่นาน
แต่กว่าจักรยานที่เราสั่งมาจากเยอรมนีจะมาถึงมือเรา มันก็ไม่ได้ง่ายเลย
...
{{< picture-lazy wrapper-class="semi-full" src="images/box-back.jpg" alt="กล่องจักรยาน ด้านหลัง" >}}
...
ส่วนผมเลือกที่จะลองเอง รู้เอง เลยเจ็บเอง .. เข็ดแล้วครับ เตื้อเดียวแต๊เน้อ

และทั้งหมดนี้ก็คือ รีวิวขั้นตอนการสั่งซื้อจักรยานจาก Canyon ครับ ขอให้มีความสุขกับการปั่นจักยานกันทุกคน

{{< picture-lazy wrapper-class="full" src="images/full.jpg" alt="รูปจักรยานทั้งคัน หลังจากประกอบเสร็จ" >}}
