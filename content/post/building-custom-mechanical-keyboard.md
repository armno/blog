...
ผมทำงานเป็น web developer มาก็หลายปี แต่เพิ่งจะมี mechanical keyboard ใช้เมื่อไม่กี่เดือนก่อน
...
ด้วยเหตุผลคือ key เป็นภาษาอังกฤษล้วน และราคาไม่ได้แพงมาก
...
- ไม่ใช่ keyboard พวก gaming series แต่เหมาะกับ typist (นักพิมพ์) มากกว่า เพราะผมไม่ได้เล่นเกม
...
ถ้าการหา mechanical keyboard สักตัวมันยากเย็นนัก ทำไมเราไม่สร้างมันขึ้นมาเองล่ะ
...
สิ่งที่ต้องบัดกรีเองก็มีแค่ขา switch ของทุกๆ key บน keyboard เท่านั้น หลังจากดู video นี้พร้อมกับ video อื่นๆ หลายรอบ
...
ใน video ที่ดู ส่วนมากคนจะใช้ Cherry Style กัน ส่วนผมดันไปซื้อแบบ Costar Style มา เพราะตอนสั่งซื้อดันไปเข้าใจว่า
...
(เพราะ keycap ที่สั่งไปจาก ebay ยังมาไม่ถึง) ทุก key ใส่ได้พอดี ลองเสียบสายแล้วทดสอบครั้งสุดท้ายอีกครั้ง

เสร็จแล้วววววว รู้สึกดีมากกกกก
...
ส่วนเรื่องความรู้สึกเทียบกันระหว่าง Cherry MX Red กับ Gateron Brown ตอนนี้ก็ยังบอกไม่ได้่มากเท่าไหร่
ผมจะรู้สึกว่า Cherry ของ M500 จะนุ่มกว่าเพราะใช้มาก่อน คงต้องใช้ keyboard ใหม่ไปสักพัก คงจะบอกความต่างได้มากกว่านี้ครับ

สำหรับเรื่อง firmware และการตั้ง custom key binding ต่างๆ ผมขอข้ามไป ไม่ลงรายละเอียดนะครับ
เพราะเดี๋ยวจะยาวเกินกว่านี้มาก เป็นเรื่องที่งงๆ ผมก็ยังมั่วๆ ไปอยู่ แต่ตอนนี้แค่พอตั้งให้ใช้ arrow key กับปุ่มเปิดเสียง/ปิดเสียงได้ ก็พอแล้วครับ

สรุปโดยรวมแล้วก็ happy กับ mechanical keyboard ทำมือตัวนี้มาก
ถือว่าได้ลองทำอะไรใหม่ๆ ได้เรียนรู้อะไรระหว่างทำอีกมากมาย ถือเป็นงานที่สนุกดี
