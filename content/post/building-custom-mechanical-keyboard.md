...
ข้อดีอีกอย่างก็คือ firmware จะติดไปกับตัว keyboard ทำให้ไม่ว่าจะไปเสียบกับเครื่องไหน ก็ใช้งาน custom firmware ของเราได้เลยทันที ไม่ต้องลงโปรแกรมเพิ่มเติมอะไร
...
โดยรวมแล้วก็ happy กับ mechanical keyboard ทำมือตัวนี้มาก
