...
ก่อนอื่นต้องเช็คบอร์ด GH60 ก่อนครับว่าใช้ได้ทุก key ไหม วิธีการเช็คก็คือนำอะไรก็ได้ที่นำไฟฟ้า แตะระหว่างรู 2 รูที่เราต้องบัดกรีขา switch เข้าไป แตะดูทีละคู่ๆ เช็คดูกับเว็บ [keyboardtester.com](https://www.keyboardtester.com/) ทุกๆ key บนบอร์ดครับ

{{< picture-lazy wrapper-class="full" src="images/03-check-pcb.jpg" alt="เช็คบอร์ด PCB GH60 ว่าใช้งานได้ปกติ" >}}
...
{{< picture-lazy wrapper-class="full" src="images/08-installing-stabilizers.jpg" alt="ติด costar style stabilizers" >}}
